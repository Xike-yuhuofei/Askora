...
| 文件 | 处置 | 说明 |
|---|---|---|
| `docs/exec-plans/README.md` | CURRENT-UPDATED | Book-to-Learning active queue；EXEC-017～022 已完成，EXEC-023～024 待执行 |
| `docs/exec-plans/completed/README.md` | CURRENT-UPDATED | 完成矩阵；当前包含 EXEC-001～022 |
