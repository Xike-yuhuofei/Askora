...
- [v1 Product Positioning — Current Main Conformance Gap Analysis](v1-Product-Positioning-Current-Main-Conformance-Gap-Analysis.md)：Historical Snapshot；判断 current conformance 必须重新读取 current `main`；
