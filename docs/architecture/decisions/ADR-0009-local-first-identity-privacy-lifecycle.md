...
Authorized objective: 真正关闭 `docs/archive/audits/product-gap-register-p1-p2.md` 的 P1-05 账号生命周期
Affected specs: `docs/specs/platform/identity-privacy-lifecycle.md`, `docs/specs/interfaces/api-contract.md`, `docs/specs/interfaces/error-contract.md`, `docs/specs/interfaces/persistence-contract.md`, `docs/specs/quality/security-standard.md`, `docs/archive/specs/ui/screen-contracts.md`, `docs/archive/specs/vertical-slices/p1-05-account-lifecycle.md`
