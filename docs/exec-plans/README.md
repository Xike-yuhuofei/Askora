...
> Active：EXEC-030（等待 durable transcript / policy-bound Book Learning baseline commit）；EXEC-037（P1-07 isolated implementation）
...
| 目录 | 当前状态 | 规则 |
|---|---|---|
| `active/` | [EXEC-030](active/EXEC-030-ui-02c-canonical-activity-lifecycle.md)、[EXEC-037](active/EXEC-037-p1-07-error-recovery-center.md) | EXEC-030 blocked；EXEC-037 在独立 worktree 实施并等待 owner capability integration gate |
