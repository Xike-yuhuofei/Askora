...
> 状态：EXEC-030、P1-01、P1-03、P1-04 DONE；P1-06 按独立冻结队列推进
> Active：EXEC-1062（P1-06 product closure）
> 已完成：EXEC-001～EXEC-033、EXEC-037～038、EXEC-1031～1034、EXEC-1061
...
| 目录 | 当前状态 | 规则 |
|---|---|---|
| `active/` | [EXEC-1062](active/EXEC-1062-p1-06b-onboarding-product-closure.md) | P1-01 的 037→038 已完成；P1-06 为 1061→1062；不得越过依赖或已冻结 owner 边界 |
| [`completed/`](completed/README.md) | EXEC-001～033、EXEC-037～038、EXEC-1031～1034、EXEC-1061 | 保留执行任务合同及其显式决策记录 |
