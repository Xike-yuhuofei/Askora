...
Affected specs: `docs/specs/platform/identity-privacy-lifecycle.md`, `docs/specs/vertical-slices/p1-05-account-lifecycle.md`, UI Settings/Onboarding/API contracts
