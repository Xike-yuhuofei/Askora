...
Affected specs: `docs/specs/architecture/state-ownership.md`, `docs/specs/interfaces/api-contract.md`, `docs/specs/ui/data-contracts.md`, UI-04 Vertical Slice, EXEC-068, EXEC-069
