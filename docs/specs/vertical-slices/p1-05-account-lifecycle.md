...
→ owner receipts + zero-residual reconciliation
...
- deletion preview、pending/cancel、durable owner erasure、reconciliation、tombstone、restore barrier；
...
- `P105-AC-005`：代表性 fixture 覆盖 SYS01～SYS08、legacy dialog/profile、文件与未提交 outbox；删除后其他用户/全局 policy 保留。
