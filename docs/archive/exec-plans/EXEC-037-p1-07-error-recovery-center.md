...
- `AGENTS.md`
- `docs/architecture/decisions/ADR-0012-unified-recovery-control-plane.md`
...
docs/planning/execs/EXEC-037-p1-07-error-recovery-center.md
docs/archive/exec-plans/EXEC-037-p1-07-error-recovery-center.md
docs/archive/exec-plans/README.md
docs/archive/releases/p1-07-error-recovery-center.md
...
最终证据见 `docs/archive/releases/p1-07-error-recovery-center.md`。`P107-AC-001..009` 全部 PASS；
