...
> Governing Audit：[`../audits/v0.3-Current-Main-Conformance-Gap-Analysis.md`](../audits/v0.3-Current-Main-Conformance-Gap-Analysis.md)
...
- `docs/design/learning/v0.3-Canonical-Design-Delta.md`
- `docs/archive/audits/v0.3-Current-Main-Conformance-Gap-Analysis.md`
...
docs/planning/execs/EXEC-042-v0.3-production-sequential-teaching-policy-closure.md
docs/archive/exec-plans/EXEC-042-v0.3-production-sequential-teaching-policy-closure.md
docs/archive/exec-plans/README.md
docs/archive/releases/v0.3-production-sequential-policy-closure.md
...
2. 更新 `docs/planning/README.md` / completed index；
3. 新建 `docs/archive/releases/v0.3-production-sequential-policy-closure.md`；
