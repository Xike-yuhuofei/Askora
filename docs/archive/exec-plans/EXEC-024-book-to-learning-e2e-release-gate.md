...
11. 创建 `docs/archive/releases/book-to-adaptive-learning.md`，分别声明 Engineering/Contract、Policy regression、Learning Evidence 状态。
12. 更新 `docs/archive/releases/README.md`、`docs/specs/README.md` implementation status、`docs/planning` 索引、document inventory；将 EXEC-024 及前序已完成 active contracts 依规则归档。
