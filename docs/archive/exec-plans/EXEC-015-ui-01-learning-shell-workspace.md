...
> Status：READY
> Depends on：EXEC-014
> Archive metadata：final status DONE；completion evidence 见 `docs/archive/releases/ui-01-learning-shell-workspace.md`。READY 保留为历史入口条件。
...
- `docs/archive/specs/vertical-slices/ui-01-learning-shell-workspace.md`
