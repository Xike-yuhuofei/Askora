...
Affected specs: `docs/specs/domain/lifecycle-state-machines.md`, `docs/specs/systems/06-activity-lifecycle.md`, `docs/specs/frontend/ui-read-model-contracts.md`, `docs/archive/specs/vertical-slices/ui-02c-canonical-activity-lifecycle.md`
