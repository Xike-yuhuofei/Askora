...
> 上位产品定义：[`个人AI辅助学习平台设计方案.md`](../../design/learning/个人AI辅助学习平台设计方案.md)
...
→ 更新 docs/archive/specs/ui/information-architecture.md
→ 更新 docs/archive/specs/ui/screen-contracts.md
→ 更新 docs/archive/specs/ui/visual-system.md
→ 必要时更新 docs/archive/specs/ui/quality-and-migration.md
