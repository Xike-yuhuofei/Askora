...
> 上游唯一研究综合：`docs/research/learning-core/synthesis/v0.3-Research-Synthesis-Adaptive-Teaching-Loop.md`
...
- `docs/research/learning-core/synthesis/v0.3-Research-Synthesis-Adaptive-Teaching-Loop.md`；
- `docs/research/learning-core/synthesis/DR-03-01-教学策略与支架转换研究.md`；
- `docs/research/learning-core/synthesis/DR-03-02-错误诊断到教学补救研究.md`；
- `docs/research/learning-core/synthesis/DR-03-03-Teaching-Policy-决策算法与数据契约研究.md`；
- `docs/research/learning-core/synthesis/DR-03-04-学习效果验证与产品实验研究.md`；
- `docs/research/learning-core/evidence/八类技术系统-参考资料索引.md`。
