...
- Vertical Slice：`docs/archive/specs/vertical-slices/ui-01-learning-shell-workspace.md`；
- execution contract：`docs/archive/exec-plans/EXEC-015-ui-01-learning-shell-workspace.md`；
